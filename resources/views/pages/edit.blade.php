...
<div class="p-3">
    <form action="{{url('/update')}}" method="post" enctype="multipart/form-data">
        ...
        <label for="formGroupExampleInput" class="form-label">
            <span class="fs-4 text-primary">Currentl pdf file:</span>
            <svg  xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-file-earmark-pdf pdf_icon_style" viewBox="0 0 16 16">
